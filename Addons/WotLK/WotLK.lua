...
p:SetWidth(1)
p:SetHeight(1)
p:SetPoint('TOPLEFT',UIParent,'TOPLEFT',0,0)
p.Texture = p:CreateTexture()
p.Texture:SetAllPoints()
 
local waitTable = {};
local waitFrame = nil;
function WaitMe_wait(delay, func, ...) -- waiter
 ...
 function WaitMe_changePX() -- call
p.Texture:SetTexture(0, 0, 5, 100)		 -- Set 0000FF when no DM.	
 end	
